...
const { commonRequestSchemas } = require("../../commons/schemas/requestSchemas");
const { commonResponseSchemas } = require("../../commons/schemas/responseSchemas");
...
const addFastifySchema = mod =>
  [...commonRequestSchemas, ...commonResponseSchemas].forEach(schema => mod.addSchema(schema));

async function ajvPlugin(fastify, { settings = defaultAjvSettngs, keywords = defaultKeywords }) {
  try {
